...
function Home() {
    ...
    const handleSubmit = (event) =>{
        ...
        axios.post('http://localhost:8081/',{Employee_Id,Employee_Name,Employee_Department,Employee_Salary,Employee_Address,Employee_DOB,Employee_Age,Date_Of_Joining})
        .then(res =>{
            navigate('/');
